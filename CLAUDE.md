...
2. **`plan/premium-grade-refactor-20260517.md` — all 13 workstreams shipped.** Verified by git-log grep on 2026-05-18:
   ...
   - **W8 follow-up**: original W8 framing was "extract RC → `@vitrum/walkaround-rc` package"; the 2026-05-18 sprint reframed it as in-package wiring (`HybridEngineRC.ts` / `RCSubsystem`). The extraction is now in progress (this session).
