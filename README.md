...
| **BDPT**                      | not applicable              | implemented + host-driven for analytic + mesh-area light subpaths; environment sources fall back to unidirectional NEE/BSDF; browser runtime promotion pending | supported safe-default path; multi-vertex research mode remains opt-in |
