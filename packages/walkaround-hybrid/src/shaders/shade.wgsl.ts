...
fn shadeMain(@builtin(global_invocation_id) gid: vec3u) {
  ...
  let Lo_direct     = lo_direct(pixelIdx, pos, normal, geoNormal, wo, albedo, rough, metal, specular, isGlass, isMetal, &rng);
  ...
  let Lo_analyticNEE = lo_analyticNEE(pos, normal, geoNormal, albedo, rough, metal, specular, wo, isGlass, isMetal);
  ...
  let Lo_sunNEE = lo_sunNEE(pix, pos, normal, geoNormal, albedo, rough, metal, specular, wo, isGlass);
  ...
  let Lo_indirectSpec = lo_indirectSpecular(pix, dims, pos, normal, wo, albedo, rough, metal, specular, isGlass);
