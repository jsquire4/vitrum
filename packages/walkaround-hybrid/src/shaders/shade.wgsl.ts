...
fn shadeMain(@builtin(global_invocation_id) gid: vec3u) {
  ...
  let Lo_sunNEE = lo_sunNEE(pix, pos, normal, clearcoatNormal, geoNormal, albedo, rough, metal, specular, anisotropy, iridescence, clearcoat, sheen, sheenRoughness, wo, isGlass);
  ...
  let Lo_indirectSpec = lo_indirectSpecular(pix, dims, pos, normal, clearcoatNormal, wo, albedo, rough, metal, specular, anisotropy, iridescence, clearcoat, sheen, sheenRoughness, isGlass);
