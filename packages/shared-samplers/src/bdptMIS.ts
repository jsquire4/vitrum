 ...
 *
 * Historical note: this module previously also exported `_partial` variants
 * (`bdptConnectionMIS_partial`, `buildBDPTStrategyPDFs_partial`) used as a
 * Sprint 10c stub for fork-side single-strategy dispatch. They were deprecated
 * and removed in W7 once the `_full` enumeration became the canonical
 * consumer-facing API.
 *
 * References:
