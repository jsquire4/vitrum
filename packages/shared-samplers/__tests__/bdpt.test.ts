...
// Note: deprecated `_partial` variants (Sprint 10c) were removed alongside
// their test blocks on 2026-05-18. The full Veach §10.3 implementation
// (bdptConnectionMIS_full / buildBDPTStrategyPDFs_full) is the canonical
// path and is tested in `bdpt-veach-full.test.ts`.
