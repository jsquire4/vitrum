...
describe('ReSTIR-PT reuse wiring — OFF by default (byte-identity)', () => {
  it('default-trace WGSL is untouched (the composed string is NOT modified by the reuse wiring)', () => {
    ...
    expect(PT_WEBGPU_TRACE_WGSL.length).toBe(313716); // re-pinned 2026-06-11 (stale pin caught during CAP-01: the authoritative SHA in wgslContract.test.ts was green while this length lagged a committed WGSL change). See wgslContract.test.ts for the authoritative SHA.
