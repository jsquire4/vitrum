...
// NOTE: Harness exports (RESTIR_PT_HYBRID_SHIFT_HARNESS_WGSL,
// packRestirPtHybridShiftInput, RESTIR_PT_HYBRID_SHIFT_INPUT_FLOATS) live in
// restirPtHybridShift.harness.wgsl.ts — kept separate from this production module.
...
// NOTE: Harness shader (RESTIR_PT_HYBRID_SHIFT_HARNESS_WGSL) and TypeScript
// helpers (packRestirPtHybridShiftInput, RESTIR_PT_HYBRID_SHIFT_INPUT_FLOATS)
// live in restirPtHybridShift.harness.wgsl.ts — kept separate from this production
// module.
