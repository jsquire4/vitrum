 ...
 * signatures carry a per-backend detail (`paramLength`'s texture-error
 * attribution), so the rest of pt-webgpu's inverse code imports from here
 ...
 *  `texture` is reserved (Phase 2) and not yet differentiable in pt-webgpu. */
