...
- Root exports are core-native and do not import THREE.
- `@vitrum/shared-bvh/legacy/three` — explicit THREE-coupled surface for `buildSceneBVH(roots, opts)` and `LegacyThreeSceneBvh`.
