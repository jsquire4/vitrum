...
describe('ATROUS_VARIANCE_WGSL', () => {
  ...
  it('is standalone for luminance-dependent edge stops', () => {
    expect(ATROUS_VARIANCE_WGSL).toContain('const LUM_W709');
    expect(ATROUS_VARIANCE_WGSL).toContain('fn luminance(c: vec3f)');
  });
