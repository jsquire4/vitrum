/**
 * Test oracle for per-bin solid-angle weights on a uniform N×N octahedral grid.
 *
 ...
 *
 * Mapping provenance: Cigolle et al. 2014, "A Survey of Efficient
 * Representations for Independent Unit Vectors", JCGT §2 / Appendix A.2,
 * documents the octahedral encode/decode mapping. It does not provide this
 * SUB×SUB planar-quad integration routine or the tolerances below; those are
 * Vitrum test-oracle choices.
 *
 ...
 *
 * The production cascade merge does not import or execute this CPU helper. Its
 * WGSL uses `rcOctCellSolidAngle`, independently composed from the exact
 * Van Oosterom-Strackee spherical-triangle formula. Tests compare that live
 * kernel against this subdivided numerical oracle.
 */
