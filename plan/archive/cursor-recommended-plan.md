...
_Current node (2026-05-09):_ types + `three-bindings` slice + `pt-webgl` factory/skeleton; **`_staging/` untouched**; **Phase B** not started in packages.
...
_End of cursor-recommended-plan.md_
