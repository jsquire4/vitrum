# Gap remediation worker — W055 / agent-01

You are **worker agent-01** in wave **W055**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-bumpScale` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-bumpScale`.
...
```
TASK_COMPLETE: MAT-WH-bumpScale
