# Gap remediation worker — W060 / agent-01

You are **worker agent-01** in wave **W060**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-sheenRoughness` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-sheenRoughness`.
...
```
TASK_COMPLETE: MAT-WH-sheenRoughness
