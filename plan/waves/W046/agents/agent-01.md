# Gap remediation worker — W046 / agent-01

You are **worker agent-01** in wave **W046**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-clearcoatNormalScale` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-clearcoatNormalScale`.
...
```
TASK_COMPLETE: MAT-WH-clearcoatNormalScale
