# Gap remediation worker — W027 / agent-01

You are **worker agent-01** in wave **W027**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-transmission` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-transmission`.
...
```
TASK_COMPLETE: MAT-WH-transmission
