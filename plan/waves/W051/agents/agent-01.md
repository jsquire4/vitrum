# Gap remediation worker — W051 / agent-01

You are **worker agent-01** in wave **W051**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-anisotropyMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-anisotropyMap`.
...
```
TASK_COMPLETE: MAT-WH-anisotropyMap
