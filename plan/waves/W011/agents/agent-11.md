# Gap remediation worker — W011 / agent-11

You are **worker agent-11** in wave **W011**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/shaders/restirGiSpatial.wgsl.ts`
