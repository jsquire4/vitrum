# Gap remediation worker — W011 / agent-23

You are **worker agent-23** in wave **W011**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/neural/inferenceGraph.ts`
