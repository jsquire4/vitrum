# Gap remediation worker — W011 / agent-25

You are **worker agent-25** in wave **W011**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/ppg/dTree.ts`
