# Gap remediation worker — W011 / agent-21

You are **worker agent-21** in wave **W011**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/pipeline/denoisers/bmfrPass.ts`
