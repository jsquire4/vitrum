# Gap remediation worker — W011 / agent-20

You are **worker agent-20** in wave **W011**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/pipeline/denoisers/atrousVariance.ts`
