# Gap remediation worker — W011 / agent-10

You are **worker agent-10** in wave **W011**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/restir/restirDiSpatial.ts`
