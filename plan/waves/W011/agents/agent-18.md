# Gap remediation worker — W011 / agent-18

You are **worker agent-18** in wave **W011**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/pipeline/wgslCompose.ts`
