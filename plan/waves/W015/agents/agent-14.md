# Gap remediation worker — W015 / agent-14

You are **worker agent-14** in wave **W015**. You own exactly **one** task.
...
- `packages/shared-denoisers/src/bmfr.ts`
...
## Hard rules
1. Implement **only** task `SDENO-004`.
