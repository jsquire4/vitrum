# Gap remediation worker — W015 / agent-15

You are **worker agent-15** in wave **W015**. You own exactly **one** task.
...
- `packages/shared-denoisers/src/hdrLuminanceBilateral.ts`
...
## Hard rules
1. Implement **only** task `SDENO-005`.
