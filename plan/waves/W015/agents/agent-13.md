# Gap remediation worker — W015 / agent-13

You are **worker agent-13** in wave **W015**. You own exactly **one** task.
...
- `packages/shared-denoisers/src/sharedWebGpuDevice.ts`
...
## Hard rules
1. Implement **only** task `SDENO-003`.
