# Gap remediation worker — W015 / agent-18

You are **worker agent-18** in wave **W015**. You own exactly **one** task.
...
- `packages/walkaround-rc/src/receiver.wgsl.ts`
