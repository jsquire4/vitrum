# Gap remediation worker — W015 / agent-04

You are **worker agent-04** in wave **W015**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/HybridEngineRC.ts`
