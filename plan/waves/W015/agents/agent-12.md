# Gap remediation worker — W015 / agent-12

You are **worker agent-12** in wave **W015**. You own exactly **one** task.
...
- `packages/shared-denoisers/src/oidnBridge.ts`
...
## Hard rules
1. Implement **only** task `SDENO-002`.
