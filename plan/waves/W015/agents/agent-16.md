# Gap remediation worker — W015 / agent-16

You are **worker agent-16** in wave **W015**. You own exactly **one** task.
...
- `packages/shared-denoisers/src/atrousVariance.ts`
...
## Hard rules
1. Implement **only** task `SDENO-006`.
