# Gap remediation worker — W015 / agent-21

You are **worker agent-21** in wave **W015**. You own exactly **one** task.
...
- `packages/scene-lighting/src/stainedGlassSky.ts`
