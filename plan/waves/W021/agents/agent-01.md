# Gap remediation worker — W021 / agent-01

You are **worker agent-01** in wave **W021**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-roughness` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-roughness`.
...
```
TASK_COMPLETE: MAT-WH-roughness
