# Gap remediation worker — W044 / agent-01

You are **worker agent-01** in wave **W044**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-clearcoatRoughnessMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-clearcoatRoughnessMap`.
...
```
TASK_COMPLETE: MAT-WH-clearcoatRoughnessMap
