# Gap remediation worker — W029 / agent-01

You are **worker agent-01** in wave **W029**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-attenuationColor` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-attenuationColor`.
...
```
TASK_COMPLETE: MAT-WH-attenuationColor
