# Gap remediation worker — W025 / agent-01

You are **worker agent-01** in wave **W025**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-alphaCutoff` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-alphaCutoff`.
...
```
TASK_COMPLETE: MAT-WH-alphaCutoff
