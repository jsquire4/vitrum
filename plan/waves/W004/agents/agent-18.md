# Gap remediation worker — W004 / agent-18

You are **worker agent-18** in wave **W004**. You own exactly **one** task.
...
- `packages/core/src/skinSolver.ts`
...
## Hard rules
1. Implement **only** task `CORE-035`.
