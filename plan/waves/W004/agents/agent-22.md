# Gap remediation worker — W004 / agent-22

You are **worker agent-22** in wave **W004**. You own exactly **one** task.
...
- `packages/core/src/scene/math.ts`
...
## Hard rules
1. Implement **only** task `CORE-039`.
