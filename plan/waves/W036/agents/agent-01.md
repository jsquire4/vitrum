# Gap remediation worker — W036 / agent-01

You are **worker agent-01** in wave **W036**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-metallicMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-metallicMap`.
...
```
TASK_COMPLETE: MAT-WH-metallicMap
