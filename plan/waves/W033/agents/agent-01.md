# Gap remediation worker — W033 / agent-01

You are **worker agent-01** in wave **W033**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-normalMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-normalMap`.
...
```
TASK_COMPLETE: MAT-WH-normalMap
