# Gap remediation worker — W045 / agent-01

You are **worker agent-01** in wave **W045**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-clearcoatNormalMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-clearcoatNormalMap`.
...
```
TASK_COMPLETE: MAT-WH-clearcoatNormalMap
