# Gap remediation worker — W059 / agent-01

You are **worker agent-01** in wave **W059**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-sheenColor` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-sheenColor`.
...
```
TASK_COMPLETE: MAT-WH-sheenColor
