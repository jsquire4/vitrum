# Gap remediation worker — W066 / agent-01

You are **worker agent-01** in wave **W066**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-specularIntensity` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-specularIntensity`.
...
```
TASK_COMPLETE: MAT-WH-specularIntensity
