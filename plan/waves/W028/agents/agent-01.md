# Gap remediation worker — W028 / agent-01

You are **worker agent-01** in wave **W028**. You own exactly **one** task.
...
## Hard rules
1. Implement **only** task `MAT-WH-ior`.
