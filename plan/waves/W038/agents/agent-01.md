# Gap remediation worker — W038 / agent-01

You are **worker agent-01** in wave **W038**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-thicknessMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-thicknessMap`.
...
```
TASK_COMPLETE: MAT-WH-thicknessMap
