# Gap remediation worker — W037 / agent-01

You are **worker agent-01** in wave **W037**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-transmissionMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-transmissionMap`.
...
```
TASK_COMPLETE: MAT-WH-transmissionMap
