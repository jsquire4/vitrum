# Gap remediation worker — W013 / agent-17

You are **worker agent-17** in wave **W013**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/pipeline/PassRegistry.ts`
