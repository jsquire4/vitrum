# Gap remediation worker — W013 / agent-19

You are **worker agent-19** in wave **W013**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/restir/bvhCore.ts`
