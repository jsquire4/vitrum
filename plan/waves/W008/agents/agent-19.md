# Gap remediation worker — W008 / agent-19

You are **worker agent-19** in wave **W008**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/restir/lightTree.ts`
...
## Hard rules
1. Implement **only** task `PTWG-043`.
