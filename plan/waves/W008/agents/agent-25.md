# Gap remediation worker — W008 / agent-25

You are **worker agent-25** in wave **W008**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/bdpt/__tests__/`
...
## Hard rules
1. Implement **only** task `PTWG-050`.
