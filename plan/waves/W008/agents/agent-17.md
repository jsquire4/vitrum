# Gap remediation worker — W008 / agent-17

You are **worker agent-17** in wave **W008**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/capabilities.ts`
...
## Hard rules
1. Implement **only** task `PTWG-038`.
