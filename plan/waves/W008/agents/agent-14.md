# Gap remediation worker — W008 / agent-14

You are **worker agent-14** in wave **W008**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/inverse/adjointEligible.ts`
...
## Hard rules
1. Implement **only** task `PTWG-034`.
