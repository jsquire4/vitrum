# Gap remediation worker — W008 / agent-15

You are **worker agent-15** in wave **W008**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/inverse/finiteDifference.ts`
...
## Hard rules
1. Implement **only** task `PTWG-035`.
