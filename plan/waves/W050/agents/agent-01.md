# Gap remediation worker — W050 / agent-01

You are **worker agent-01** in wave **W050**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-iridescenceThicknessMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-iridescenceThicknessMap`.
...
```
TASK_COMPLETE: MAT-WH-iridescenceThicknessMap
