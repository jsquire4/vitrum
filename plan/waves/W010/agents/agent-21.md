# Gap remediation worker — W010 / agent-21

You are **worker agent-21** in wave **W010**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/shaders/jacobianShift.wgsl.ts`
