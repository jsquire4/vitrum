# Gap remediation worker — W010 / agent-17

You are **worker agent-17** in wave **W010**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/restir/restirDiTemporal.ts`
