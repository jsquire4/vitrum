# Gap remediation worker — W010 / agent-13

You are **worker agent-13** in wave **W010**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/ddgi/probeUpdateFrameParams.ts`
