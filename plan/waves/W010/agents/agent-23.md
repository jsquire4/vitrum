# Gap remediation worker — W010 / agent-23

You are **worker agent-23** in wave **W010**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/shaders/restirGiTemporal.wgsl.ts`
