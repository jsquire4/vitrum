# Gap remediation worker — W010 / agent-18

You are **worker agent-18** in wave **W010**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/restir/__tests__/`
