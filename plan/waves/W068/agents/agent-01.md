# Gap remediation worker — W068 / agent-01

You are **worker agent-01** in wave **W068**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-anisotropy` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-anisotropy`.
...
```
TASK_COMPLETE: MAT-WH-anisotropy
