# Gap remediation worker — W034 / agent-01

You are **worker agent-01** in wave **W034**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-normalScale` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-normalScale`.
...
```
TASK_COMPLETE: MAT-WH-normalScale
