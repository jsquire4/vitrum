# Gap remediation worker — W042 / agent-01

You are **worker agent-01** in wave **W042**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-aoMapIntensity` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-aoMapIntensity`.
...
```
TASK_COMPLETE: MAT-WH-aoMapIntensity
