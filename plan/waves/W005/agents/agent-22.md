# Gap remediation worker — W005 / agent-22

You are **worker agent-22** in wave **W005**. You own exactly **one** task.
...
- `packages/engine/src/progressiveHandoff.ts`
