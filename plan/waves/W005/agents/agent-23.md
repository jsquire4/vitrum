# Gap remediation worker — W005 / agent-23

You are **worker agent-23** in wave **W005**. You own exactly **one** task.
...
- `packages/engine/src/configureWebGpuCanvas.ts`
