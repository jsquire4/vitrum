# Gap remediation worker — W005 / agent-15

You are **worker agent-15** in wave **W005**. You own exactly **one** task.
...
- `packages/core/src/gpuDetection.ts`
...
## Hard rules
1. Implement **only** task `CORE-046`.
