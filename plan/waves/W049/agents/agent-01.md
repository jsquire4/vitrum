# Gap remediation worker — W049 / agent-01

You are **worker agent-01** in wave **W049**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-iridescenceMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-iridescenceMap`.
...
```
TASK_COMPLETE: MAT-WH-iridescenceMap
