# Gap remediation worker — W035 / agent-01

You are **worker agent-01** in wave **W035**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-roughnessMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-roughnessMap`.
...
```
TASK_COMPLETE: MAT-WH-roughnessMap
