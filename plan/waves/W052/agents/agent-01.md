# Gap remediation worker — W052 / agent-01

You are **worker agent-01** in wave **W052**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-specularColorMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-specularColorMap`.
...
```
TASK_COMPLETE: MAT-WH-specularColorMap
