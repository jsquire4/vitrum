# Gap remediation worker — W012 / agent-18

You are **worker agent-18** in wave **W012**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/neural/nrc/nrcInferPass.ts`
