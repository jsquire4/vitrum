# Gap remediation worker — W012 / agent-08

You are **worker agent-08** in wave **W012**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/shaders/restirGiTrace.wgsl.ts`
