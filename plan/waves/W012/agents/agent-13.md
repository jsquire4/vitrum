# Gap remediation worker — W012 / agent-13

You are **worker agent-13** in wave **W012**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/pipeline/denoisers/oidnFinalPass.ts`
