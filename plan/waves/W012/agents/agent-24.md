# Gap remediation worker — W012 / agent-24

You are **worker agent-24** in wave **W012**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/environment/proceduralSkyBake.ts`
