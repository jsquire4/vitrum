# Gap remediation worker — W012 / agent-17

You are **worker agent-17** in wave **W012**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/neural/nrc/nrcTrainPass.ts`
