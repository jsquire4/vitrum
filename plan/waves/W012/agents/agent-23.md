# Gap remediation worker — W012 / agent-23

You are **worker agent-23** in wave **W012**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/giStateSnapshot.ts`
