# Gap remediation worker — W012 / agent-16

You are **worker agent-16** in wave **W012**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/ppg/__tests__/`
