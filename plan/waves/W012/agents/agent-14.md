# Gap remediation worker — W012 / agent-14

You are **worker agent-14** in wave **W012**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/ppg/ppgGuidePass.ts`
