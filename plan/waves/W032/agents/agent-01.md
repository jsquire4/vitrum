# Gap remediation worker — W032 / agent-01

You are **worker agent-01** in wave **W032**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-baseColorMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-baseColorMap`.
...
```
TASK_COMPLETE: MAT-WH-baseColorMap
