# Gap remediation worker — W043 / agent-01

You are **worker agent-01** in wave **W043**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-clearcoatMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-clearcoatMap`.
...
```
TASK_COMPLETE: MAT-WH-clearcoatMap
