# Gap remediation worker — W030 / agent-01

You are **worker agent-01** in wave **W030**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-attenuationDistance` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-attenuationDistance`.
...
```
TASK_COMPLETE: MAT-WH-attenuationDistance
