# Gap remediation worker — W002 / agent-16

You are **worker agent-16** in wave **W002**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/restir/restirGiMaterial.wgsl.ts`
