# Gap remediation worker — W002 / agent-25

You are **worker agent-25** in wave **W002**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/pipeline/denoisers/svgfRealPass.ts`
