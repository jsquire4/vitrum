# Gap remediation worker — W007 / agent-23

You are **worker agent-23** in wave **W007**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/scene/materialsBuffer.ts`
...
## Hard rules
1. Implement **only** task `PTWG-019`.
