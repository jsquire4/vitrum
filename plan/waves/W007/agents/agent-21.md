# Gap remediation worker — W007 / agent-21

You are **worker agent-21** in wave **W007**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/shaders/spectral.wgsl.ts`
...
## Hard rules
1. Implement **only** task `PTWG-016`.
