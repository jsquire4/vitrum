# Gap remediation worker — W007 / agent-19

You are **worker agent-19** in wave **W007**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/shaders/bsdf.wgsl.ts`
...
## Hard rules
1. Implement **only** task `PTWG-013`.
