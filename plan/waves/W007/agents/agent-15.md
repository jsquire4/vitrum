# Gap remediation worker — W007 / agent-15

You are **worker agent-15** in wave **W007**. You own exactly **one** task.
...
- `packages/pt-webgl2/src/glsl/render/direct_light_contribution_function.glsl.js`
...
## Hard rules
1. Implement **only** task `PTGL-027`.
