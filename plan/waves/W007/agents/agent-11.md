# Gap remediation worker — W007 / agent-11

You are **worker agent-11** in wave **W007**. You own exactly **one** task.
...
- `packages/pt-webgl2/src/scene/solveSkinPrimitives.ts`
...
## Hard rules
1. Implement **only** task `PTGL-022`.
