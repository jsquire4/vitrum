# Gap remediation worker — W065 / agent-01

You are **worker agent-01** in wave **W065**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-iridescenceThicknessRange` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-iridescenceThicknessRange`.
...
```
TASK_COMPLETE: MAT-WH-iridescenceThicknessRange
