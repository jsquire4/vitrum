# Gap remediation worker — W064 / agent-01

You are **worker agent-01** in wave **W064**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-iridescenceIor` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-iridescenceIor`.
...
```
TASK_COMPLETE: MAT-WH-iridescenceIor
