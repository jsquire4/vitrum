# Gap remediation worker — W039 / agent-01

You are **worker agent-01** in wave **W039**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-emissiveMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-emissiveMap`.
...
```
TASK_COMPLETE: MAT-WH-emissiveMap
