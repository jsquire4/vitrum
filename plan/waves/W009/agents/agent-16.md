# Gap remediation worker — W009 / agent-16

You are **worker agent-16** in wave **W009**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/restirPt/__tests__/`
...
## Hard rules
1. Implement **only** task `PTWG-054`.
