# Gap remediation worker — W009 / agent-18

You are **worker agent-18** in wave **W009**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/restirPt/`
...
## Hard rules
1. Implement **only** task `PTWG-056`.
