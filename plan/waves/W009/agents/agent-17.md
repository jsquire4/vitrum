# Gap remediation worker — W009 / agent-17

You are **worker agent-17** in wave **W009**. You own exactly **one** task.
...
- `packages/pt-webgpu/src/restirPt/restirPtSubsystem.ts`
...
## Hard rules
1. Implement **only** task `PTWG-055`.
