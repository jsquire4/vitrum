# Gap remediation worker — W047 / agent-01

You are **worker agent-01** in wave **W047**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-sheenColorMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-sheenColorMap`.
...
```
TASK_COMPLETE: MAT-WH-sheenColorMap
