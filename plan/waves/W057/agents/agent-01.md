# Gap remediation worker — W057 / agent-01

You are **worker agent-01** in wave **W057**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-lightMapIntensity` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-lightMapIntensity`.
...
```
TASK_COMPLETE: MAT-WH-lightMapIntensity
