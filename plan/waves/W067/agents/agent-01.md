# Gap remediation worker — W067 / agent-01

You are **worker agent-01** in wave **W067**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-specularColor` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-specularColor`.
...
```
TASK_COMPLETE: MAT-WH-specularColor
