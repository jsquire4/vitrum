# Gap remediation worker — W014 / agent-20

You are **worker agent-20** in wave **W014**. You own exactly **one** task.
...
- `packages/shared-bvh/src/validateBvhEncoding.ts`
...
## Hard rules
1. Implement **only** task `SBVH-007`.
