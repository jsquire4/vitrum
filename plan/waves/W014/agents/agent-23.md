# Gap remediation worker — W014 / agent-23

You are **worker agent-23** in wave **W014**. You own exactly **one** task.
...
- `packages/shared-samplers/src/uboCodegen.ts`
...
## Hard rules
1. Implement **only** task `SSAMP-003`.
