# Gap remediation worker — W014 / agent-24

You are **worker agent-24** in wave **W014**. You own exactly **one** task.
...
- `packages/shared-samplers/src/spectral.ts`
...
## Hard rules
1. Implement **only** task `SSAMP-004`.
