# Gap remediation worker — W014 / agent-25

You are **worker agent-25** in wave **W014**. You own exactly **one** task.
...
- `packages/shared-samplers/src/bdpt.ts`
...
## Hard rules
1. Implement **only** task `SSAMP-005`.
