# Gap remediation worker — W014 / agent-07

You are **worker agent-07** in wave **W014**. You own exactly **one** task.
...
- `packages/walkaround-hybrid/src/pipeline/frameResources.ts`
