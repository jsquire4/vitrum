# Gap remediation worker — W070 / agent-01

You are **worker agent-01** in wave **W070**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-anisotropyRotation` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-anisotropyRotation`.
...
```
TASK_COMPLETE: MAT-WH-anisotropyRotation
