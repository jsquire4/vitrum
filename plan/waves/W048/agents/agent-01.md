# Gap remediation worker — W048 / agent-01

You are **worker agent-01** in wave **W048**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-sheenRoughnessMap` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-sheenRoughnessMap`.
...
```
TASK_COMPLETE: MAT-WH-sheenRoughnessMap
