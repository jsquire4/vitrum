# Gap remediation worker — W061 / agent-01

You are **worker agent-01** in wave **W061**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-clearcoat` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-clearcoat`.
...
```
TASK_COMPLETE: MAT-WH-clearcoat
