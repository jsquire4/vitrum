# Gap remediation worker — W062 / agent-01

You are **worker agent-01** in wave **W062**. You own exactly **one** task.

## Task identity
| Field | Value |
|-------|-------|
| Task ID | `MAT-WH-clearcoatRoughness` |
| Lane | `core` |
| Disposition | `TOG` |
| Priority | `P2` |
...
## Hard rules
1. Implement **only** task `MAT-WH-clearcoatRoughness`.
...
```
TASK_COMPLETE: MAT-WH-clearcoatRoughness
