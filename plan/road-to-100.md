...
✅ **ADAPTER-BACKED PT MATERIAL/ENVIRONMENT/EMITTER/TRANSFORM/TOPOLOGY/INSTANCED-COUNT MUTATION PROOFS ADDED (2026-06-17):**
...
2026-06-17 follow-up: the same six mutation lanes now also pass through
...
Remaining proof is broader adapter-backed end-to-end promotion: resource mutation
lanes, cached bind groups, denoiser history, and walkaround GI propagation
observed together under the WSL GPU/browser harness.
