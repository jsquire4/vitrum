...
> (`normalScale`, `bumpScale`, `clearcoatNormalScale`) while requested path
> replay downgrades them explicitly until analytic normal terms are mirrored.
