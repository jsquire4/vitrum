...
| `clearcoat*Map`, `sheen*Map`, `iridescence*Map`, `specular*Map` | Extend descriptor list (pt-webgl2 has 17 maps; pt-webgpu now consumes 10 material maps plus scalar extension lobes) | **H52:** pt-webgpu packs scalars but not maps for these extension lobes |
