...
> `kind:'vec2'` finite-difference inverse sessions and patches the live material
> range, while requested path replay keeps a structured unsupported-field
> downgrade until analytic thin-film thickness derivatives are mirrored.
