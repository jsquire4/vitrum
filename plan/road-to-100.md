...
pt radiometric host-status JSON, and walkaround host-status JSON
machine-checkable without a new GPU recapture.
...
promotion evidence. This is still snapshot/status evidence;
