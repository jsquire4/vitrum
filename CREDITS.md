...
- **glTF material extensions** — Khronos Group: KHR_materials_clearcoat, KHR_materials_sheen, KHR_materials_iridescence (glTF 2.0 extension specifications, <https://github.com/KhronosGroup/glTF>). These specs define the clearcoat (additive GGX at IOR 1.5), sheen (Charlie distribution retro-reflective highlight), and iridescence (thin-film F0 override) lobe semantics implemented in H52 for `@vitrum/pt-webgpu`.
